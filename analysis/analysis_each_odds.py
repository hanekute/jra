...
new_df['1着'] = chaku1.groupby(odds).count()['着順']
new_df['2着'] = chaku2.groupby(odds).count()['着順']
new_df['3着'] = chaku3.groupby(odds).count()['着順']
...
caption_df.to_csv(OUTPUT_CSV + 'odds_data.csv', index=False, encoding="shift-jis", mode='a')
new_df.to_csv(OUTPUT_CSV + 'odds_data.csv', encoding="shift-jis", mode='a')
